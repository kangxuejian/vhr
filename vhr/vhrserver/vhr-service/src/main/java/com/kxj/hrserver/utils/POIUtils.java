...
public class POIUtils {
    ...
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list){
        ...
        //文档管理员
        docInfo.setManager("kxj");
        //设置公司信息
        docInfo.setCompany("kxj");
        //4.获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //文档标题
        summInfo.setTitle("员工信息表");
        //文档作者
        summInfo.setAuthor("kxj");
        //文档备注
        summInfo.setComments("本文档由kxj提供");
        //5.创建样式
        //创建标题行的样式
        ...
        for (int i = 0; i < list.size(); i++) {
             ...
             cell4.setCellValue(emp.getBeginDate());
    ...
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations, List<PoliticsStatus> allPoliticsStatus,
                                                List<Department> allDepartments, List<Position> allPositions,
