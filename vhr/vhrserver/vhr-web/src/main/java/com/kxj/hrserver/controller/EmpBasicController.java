...
import com.kxj.hrserver.service.*;
import com.kxj.hrserver.utils.POIUtils;
...
public class EmpBasicController {
    ...
    public RespBean importData(MultipartFile file) throws IOException {
        List<Employee> list = POIUtils.excel2Employee(file, nationService.getAllNations(), politicsstatusService.getAllPoliticsstatus(),
                departmentService.getAllDepartmentsWithOutChildren(), positionService.getAllPos(),jobLevelService.getAllJobLevels());
