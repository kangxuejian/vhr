            ...
            <transition name="slide-fade">
                <div v-show="showAdvanceSearchView"
                    ...
                    <el-row>
                        ...
                        <el-col :span="4">
                            职称：
                            <el-select v-model="searchValue.jobLevelId" placeholder="职位" size="mini" style="width:130px;">
                                <el-option
                            ...
                            <el-popover
                                ...
                                <div
                                    ...
                                    style="width:130px;display:inline-flex;font-size:13px;border:1px solid #dedede;
                                            height:26px;border-radius:5px;cursor:pointer;aligin-items:center;padding-left:8px;
                                            box-sizing:border-box;marging-left:3px;"
            ...
            <div>
                <el-form :model="emp" :rules="rules" ref="empForm">
                    ...
                    <el-row>
                        ...
                        <el-col :span="7">
                            <el-form-item label="专业名词:" prop="specialty">
                                <el-input size="mini" style="width:200px;" prefix-icon="el-icon-edit"
